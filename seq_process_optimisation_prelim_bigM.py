...
nn_compressor_T = keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\compressor_nn_T_relu.keras', compile=False)
nn_compressor_E = keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\compressor_nn_P_relu.keras', compile=False)
nn_compressor_T_HP = keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\compressor_nn_T_CO2_relu.keras', compile=False)
nn_compressor_E_HP = keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\compressor_nn_E_CO2_relu.keras', compile=False)
nn_compressor_T_HP2 = keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\compressor_nn_T_H2_relu.keras', compile=False)
nn_compressor_E_HP2 = keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\compressor_nn_E_H2_relu.keras', compile=False)

nn_mixer_feed = keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\mixer_nn_relu.keras', compile=False)
nn_mixer_reactor = keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\mixer_nn_2_relu.keras', compile=False)
...
nn_cooler_E = keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\cooler_E_relu.keras', compile=False)
nn_cooler_VD = keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\cooler_VD_relu.keras', compile=False)
nn_cooler_LD = keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\cooler_LD_relu.keras', compile=False)

nn_compressor_T_mix= keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\compressor_nn_Mix_T_relu.keras', compile=False)
nn_compressor_E_mix= keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\compressor_nn_Mix_E_relu.keras', compile=False)
...
nn_valve_VD=keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\valve_VD_relu.keras', compile=False)
nn_valve_LD=keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\valve_LD.keras', compile=False)

nn_heater=keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\pre_heater_new_relu.keras', compile=False)

nn_dis_vap_co2=keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\dis_vap_co2.keras', compile=False)
nn_dis_vap_ch3oh=keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\dis_vap_ch3oh_2_relu.keras', compile=False)
...
nn_dis_con_T=keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\dis_con_T_relu.keras', compile=False)
nn_dis_reb_T=keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\dis_reb_T_relu.keras', compile=False)
nn_dis_con_duty=keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\dis_con_duty_relu.keras', compile=False)
nn_dis_reb_duty=keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\dis_reb_duty_relu.keras', compile=False)
nn_dis_VD=keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\dis_VD_relu.keras', compile=False)
nn_dis_LD=keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\dis_LD_relu.keras', compile=False)
nn_dis_max_vap=keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\dis_max_vap_rate_relu.keras', compile=False)
...
nn_cooler_power_2=keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\cooler_energy_2_relu.keras', compile=False)
nn_cooler_VD_2=keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\cooler_VD_2_relu.keras', compile=False)
nn_cooler_LD_2=keras.models.load_model('C:\\Users\\SHREEYA\\Cheat sheets\\Pyomo_practice\\cooler_LD_2_relu.keras', compile=False)
...
m.valve_VD.build_formulation(ReluBigMFormulation(netV9))
...
m.heater.build_formulation(ReluBigMFormulation(netH1))
...
m.dis_vap_ch3oh.build_formulation(ReluBigMFormulation(netD2))
...
#%%
"""
m.compressor_E1_out=pyo.Var(bounds=(500,10000), initialize=5000)
m.compressor_E2_out=pyo.Var(bounds=(500,10000), initialize=5000)
m.compressor_E3_out=pyo.Var(bounds=(500,10000), initialize=5000)
m.compressor_E4_out=pyo.Var(bounds=(500,10000), initialize=5000)
m.compressor_H2_E_out=pyo.Var(bounds=(500,10000), initialize=5000)
m.compressor_Mix_E_out=pyo.Var(bounds=(500,10000), initialize=5000)
m.reactor_comp_in=pyo.Var(bounds=(1e-20,60), initialize=55)
m.cooler_VD_out=pyo.Var(bounds=(1e-20,100), initialize=30)
m.cooler_LD_out=pyo.Var(bounds=(1e-20,1500), initialize=900)
m.valve_VD_out=pyo.Var(bounds=(1e-20,100), initialize=2)
m.valve_LD_out=pyo.Var(bounds=(1e-20,1500), initialize=900)
m.dis_VD_out=pyo.Var(bounds=(1e-20,100), initialize=2)
m.dis_LD_out=pyo.Var(bounds=(1e-20,1500), initialize=900)
m.cooler_VD_2_out=pyo.Var(bounds=(1e-20,100), initialize=2)
m.cooler_LD_2_out=pyo.Var(bounds=(1e-20,1500), initialize=900)
m.cooler_liq_ch3oh_2_out=pyo.Var(bounds=(1e-20,3000), initialize=3000)
m.dis_vap_ch3oh_out=pyo.Var(bounds=(1e-20,3500), initialize=3000)
"""
#%%
...
"""
#%%
pyomo.util.model_size.build_model_size_report(m)
#%%
solver = pyo.SolverFactory('scip')
solver.options ={'limits/time': 21600, 'limits/gap': 0.01, 'numerics/feastol': 1e-4, 'numerics/dualfeastol': 1e-4, 'propagating/obbt/dualfeastol': 1e-04,'heuristics/multistart/maxboundsize': 300000}
