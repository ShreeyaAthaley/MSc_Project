...
#%%
m.THIN_link1=pyo.Constraint(expr=m.TIN_H[1]==413.7573)
m.THIN_link2=pyo.Constraint(expr=m.TIN_H[2]==393.2211)
...
m.F_H = pyo.Var(m.IP, bounds=fb5, initialize={1: 22.2472, 2: 22.6500, 3:25.3917, 4:544.1565 , 5: 826.5870, 6: 21971.7512, 7:10000})
m.F_C = pyo.Var(m.J, bounds=fb6, initialize={1: 538.6997, 2:543.2786  ,3:16162.7088, 4:5000, 5: 5000})
#%%
...
m.FH_link4=pyo.Constraint(expr=m.F_H[4]==57405.5183/3600*34.125)
m.FH_link5=pyo.Constraint(expr=m.F_H[5]==1949.5231/3600*1526.38)
m.FH_link6=pyo.Constraint(expr=m.F_H[6]==21971.7512) #directly equate to predicted duty 

m.FC_link1=pyo.Constraint(expr=m.F_C[1]==60898.6931/3600*31.845)
m.FC_link2=pyo.Constraint(expr=m.F_C[2]==3844.1411/3600*508.775) 
...
solver.options ={'limits/time': 60, 'limits/gap': 0.001, 'numerics/feastol': 1e-5, 'numerics/dualfeastol': 1e-5, 'propagating/obbt/dualfeastol': 1e-04}#,'heuristics/multistart/maxboundsize': 10001}
