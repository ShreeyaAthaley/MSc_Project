...
m.cooler_VD_2.build_formulation(ReluComplementarityFormulation(netC06))
netC07 = load_keras_sequential(nn_cooler_LD_2, scaling_object=scalerC07, scaled_input_bounds=scaled_input_bounds4)
m.cooler_LD_2.build_formulation(ReluComplementarityFormulation(netC07))
...
#2
m.total_opex = pyo.Var(bounds=(2,8),initialize=5)
m.total_capex = pyo.Var(bounds=(8,14),initialize=11)

m.compc1=pyo.Var(bounds=(55,70),initialize=60)
m.compc2=pyo.Var(bounds=(55,70),initialize=60)
m.compc3=pyo.Var(bounds=(50,65),initialize=58)
m.compc4=pyo.Var(bounds=(50,65),initialize=58)
m.compc5=pyo.Var(bounds=(100,115),initialize=110)
m.compc6=pyo.Var(bounds=(125,150),initialize=140)

m.reactorc=pyo.Var(bounds=(40,55),initialize=50)

m.vesselc4=pyo.Var(bounds=(40,60),initialize=50)

m.TAC=pyo.Var(bounds=(0,2),initialize=1)
...
#3
m.total_opex = pyo.Var(bounds=(2,8),initialize=6.921202518630123)
m.total_capex = pyo.Var(bounds=(8,14),initialize=12.600216135742375)

m.compc1=pyo.Var(bounds=(55,70),initialize=61.940163936451256)
m.compc2=pyo.Var(bounds=(55,70),initialize=66.33630154099461)
m.compc3=pyo.Var(bounds=(50,65),initialize=57.43834507131868)
m.compc4=pyo.Var(bounds=(50,65),initialize=61.03397197007398)
m.compc5=pyo.Var(bounds=(100,115),initialize=112.29896702523605)
m.compc6=pyo.Var(bounds=(125,150),initialize=143.05702591419367)

m.reactorc=pyo.Var(bounds=(40,55),initialize=50.65425131151498)

m.vesselc4=pyo.Var(bounds=(40,60),initialize=52.0513477458508)

m.TAC=pyo.Var(bounds=(0,2),initialize=0.5272237448818086)
m.Total_Energy=pyo.Var(bounds=(15000,30000), initialize=23101.608495675006)
m.cooler_liq_ch3oh_2_out=pyo.Var(bounds=(1000,2000), initialize=1503.7458653845888)
